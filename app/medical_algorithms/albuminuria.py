"""
Назначение файла: расчёт ACR и категории альбуминурии A1/A2/A3.

Что выполняет файл
-------------------
Рассчитывает альбумин-креатининовое отношение мочи и определяет категорию
альбуминурии по ACR либо по суточной экскреции альбумина.

Что происходит в этом файле
---------------------------
Здесь рассчитывается ACR — отношение альбумина к креатинину в моче, а также
определяется категория альбуминурии A1/A2/A3 по ACR или по суточной экскреции
альбумина.
...
По суточной экскреции альбумина:
- A1: < 30 мг/сут
- A2: 30–300 мг/сут
- A3: > 300 мг/сут
...
def get_daily_albumin_excretion_category(daily_albumin_excretion):
    """Определяет A1/A2/A3 по суточной экскреции альбумина в мг/сут."""
    value = to_float(daily_albumin_excretion)
