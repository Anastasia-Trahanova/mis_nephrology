...
ACTION_LABELS = {
    ...
    "open_patient_appointment": "Открыл конкретный приём пациента",
    ...
    "open_ckd_registry": "Открыл списки пациентов (старое название)",
    "open_patient_lists": "Открыл списки пациентов",
    "filter_patient_lists": "Сформировал список пациентов",
    "export_patient_lists": "Выгрузил список пациентов",
    "open_local_ckd_registry": "Открыл регистр ХБП",
    "filter_local_ckd_registry": "Применил фильтры регистра ХБП",
    "export_local_ckd_registry": "Выгрузил регистр ХБП",
    "include_local_ckd_registry_patient": "Включил пациента в регистр ХБП",
    "remove_local_ckd_registry_patient": "Удалил пациента из регистра ХБП",
    "add_local_ckd_registry_outcome": "Добавил исход в регистр ХБП",
...
ACTION_CATEGORIES = {
    ...
    "open_patient_appointment": "view",
    "open_new_patient_form": "view",
    "open_new_appointment_form": "view",
    "open_ckd_registry": "view",
    "open_patient_lists": "view",
    "filter_patient_lists": "view",
    "export_patient_lists": "export",
    "open_local_ckd_registry": "view",
    "filter_local_ckd_registry": "view",
    "export_local_ckd_registry": "export",
    "include_local_ckd_registry_patient": "patient",
    "remove_local_ckd_registry_patient": "patient",
    "add_local_ckd_registry_outcome": "patient",
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                SELECT
                    ...
                    COUNT(*) FILTER (WHERE action IN ('download_word_report', 'export_audit_log', 'export_patient_lists', 'export_local_ckd_registry')) AS export_events,
